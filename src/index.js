...
class AppScene extends Component {
    ...
    navigator.mediaDevices
      ...
      .then(stream => {
        ...
        this.scriptProcessor.onaudioprocess = AudioProcessingEvent => {
          ...
          this.setState({ audioLevels: this.audioLevels, waveform: this.waveform, volume: this.volume });
        };
  ...
  render() {
    const newBox1 = ((this.state.audioLevels[15]) / 100) > 1 ? 1 : ((this.state.audioLevels[15]) / 100);
    const newBox2 = ((this.state.audioLevels[30]) / 100) > 1 ? 1 : ((this.state.audioLevels[30]) / 100);
    const newBox3 = ((this.state.audioLevels[45]) / 100) > 1 ? 1 : ((this.state.audioLevels[45]) / 100);
